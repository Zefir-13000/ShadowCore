...
void SC::Transform::Translate(const glm::vec3& pos) {
	Transform::position = pos;
	Transform::T = glm::translate(pos);
	Transform::Update();
}

void SC::Transform::Rotate(const glm::vec3& rot) {
...
void SC::Transform::Scale(const glm::vec3& scale) {
