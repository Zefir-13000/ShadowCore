...
SC::Mesh::Mesh(std::string _name, std::vector<float>& _vertices) : RenderObject(_name, _vertices) {
    type = MESH;
}

SC::Mesh::Mesh(std::string _name, std::vector<Vertex>& _vertices) : RenderObject(_name, _vertices) {
    type = MESH;
}

SC::Mesh::Mesh(std::string _name, std::vector<float> _vertices, UseLessType _u_type) : RenderObject(_name, _vertices) {
    type = MESH;
}

SC::Mesh::Mesh(std::string _name, std::vector<Vertex> _vertices, UseLessType _u_type) : RenderObject(_name, _vertices) {
    type = MESH;
}
