...
struct ImVec2
{
    ...
    ImVec2 Add(ImVec2& other)        { ImVec2 res = *this; res.x += other.x; res.y += other.y; return res; }
    ImVec2 Sub(ImVec2& other)        { ImVec2 res = *this; res.x -= other.x; res.y -= other.y; return res; }
    ImVec2 Divide(ImVec2& other)            { ImVec2 res = *this; res.x /= other.x; res.y /= other.y; return res; }
    ImVec2 Divide(int val)                  { ImVec2 res = *this; res.x /= val; res.y /= val; return res; }
