...
SC::Model::Model(std::string _name, std::vector<float>& _vertices) : Mesh(_name, _vertices) {
    type = MESH;
    Model::vertices = ArrayToVertex(_vertices);
    //aabb_box = std::make_shared<AABB>(_vertices);
}

SC::Model::Model(std::string _name, std::vector<Vertex>& _vertices) : Mesh(_name, _vertices) {
    type = MESH;
    Model::vertices = _vertices;
    //aabb_box = std::make_shared<AABB>(_vertices);
}

SC::Model::Model(std::string _name, std::vector<float> _vertices, UseLessType _u_type) : Mesh(_name, _vertices) {
    type = MESH;
    Model::vertices = ArrayToVertex(_vertices);
    //aabb_box = std::make_shared<AABB>(_vertices);
}

SC::Model::Model(std::string _name, std::vector<Vertex> _vertices, UseLessType _u_type) : Mesh(_name, _vertices) {
    type = MESH;
    Model::vertices = _vertices;
    //aabb_box = std::make_shared<AABB>(_vertices);
}
